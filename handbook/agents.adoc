...
TIP: Unet modems also have a `classes` folder that accepts Groovy source files or compiled Java/Groovy class files. You can you the web interface of the modem to upload files to that folder. If your code has many class files that, you may wish to package them together into a jar archive and place it in the `jars` folder.
