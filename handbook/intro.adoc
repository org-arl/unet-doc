...
ifdef::backend-html5[]
****
TIP: The material in this section is also available as a {url-youtube-intro}[short video].
****
endif::backend-html5[]
...
ifdef::backend-html5[]
****
TIP: The material in this section is also available as a {url-youtube-overview}[short video].
****
endif::backend-html5[]
