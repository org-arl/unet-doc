...
* {url-unet-javadoc}org/arl/unet/bb/GetPreambleSignalReq.html[`GetPreambleSignalReq`] => `REFUSE` / {url-unet-javadoc}org/arl/unet/bb/BasebandSignal.html[`BasebandSignal`^] -- get baseband preamble signal
