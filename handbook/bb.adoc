...
Out[4]:  Message:AGREE[sentAt:1586066631250]
...
Out[6]:  Message:AGREE[sentAt:1586066756231]

In[7]:   # obtain the recording notification and check that it's of the correct type
         ntf = gw.receive(timeout=5000)
         ntf
Out[7]:  RxBasebandSignalNtf:INFORM[rxTime:153625687 rssi:-60.704174 adc:1 fc:12000.0 fs:12000.0 channels:1 preamble:0 sentAt:1586066761705  ... (65536 samples)]
